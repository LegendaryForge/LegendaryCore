...
final class DefaultEncounterManagerSpectatorDisallowIntegrationTest {

    @Test
    void spectatorDisallow_deniesSpectatorJoin_evenWhenPublic_participantStillAllowed() {
        ...
        assertEquals(JoinResult.DENIED_POLICY, mgr.join(player, inst, ParticipationRole.SPECTATOR));
        assertEquals(JoinResult.SUCCESS, mgr.join(player, inst, ParticipationRole.PARTICIPANT));
    }
